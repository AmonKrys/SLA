        ...
        * ***************************************************************************/
        public int Incluir(Cliente aobj_Cliente)
        {
            ...
            string varSql = "INSERT INTO TB_CLIENTE " +
                ...
                objCmd.Parameters.AddWithValue("@S_NOME_CLIENTE ", aobj_Cliente.NOME_CLIENTE);
                objCmd.Parameters.AddWithValue("@S_EMAIL_CLIENTE", aobj_Cliente.EMAIL_CLIENTE);
                objCmd.Parameters.AddWithValue("@S_TEL_CLIENTE  ", aobj_Cliente.TEL_CLIENTE);
        ...
        public Cliente FindByCodCliente(Cliente aobj_Cliente)
        {
            ...
            try
            {
                ...
                if (objDtr.HasRows)
                {
                    ...
                    aobj_Cliente.NOME_CLIENTE = objDtr["S_NOME_CLIENTE"].ToString();
                    aobj_Cliente.EMAIL_CLIENTE = Convert.ToString(objDtr["S_EMAIL_CLIENTE"]);
                    aobj_Cliente.TEL_CLIENTE = Convert.ToString(objDtr["S_TEL_CLIENTE"]);
                    aobj_Cliente.BAI_CLIENTE = Convert.ToString(objDtr["S_BAI_CLIENTE"]);
                    aobj_Cliente.CID_CLIENTE = Convert.ToString(objDtr["S_CID_CLIENTE"]);
                    aobj_Cliente.UF_CLIENTE = Convert.ToString(objDtr["S_UF_CLIENTE"]);
                    aobj_Cliente.CEP_CLIENTE = Convert.ToString(objDtr["S_CEP_CLIENTE"]);
            ...
            try
            {
                ...
                if (objDtr.HasRows)
                {
                    while (objDtr.Read())
                    {
                        ...
                        aobj_Cliente.TEL_CLIENTE = objDtr["S_TEL_CLIENTE"].ToString();
